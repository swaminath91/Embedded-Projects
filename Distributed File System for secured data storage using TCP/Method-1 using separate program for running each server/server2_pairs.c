...
/* ***************************************************************************** */
 if (client_fd<0)              //if there are negative request, then error
            error ("accept() error");
...
{
char *directory = "/home/swaminath/Downloads/split/pairs/server2/Alice";
chdir (directory); 
printf("\n We are under Alice folder ");
}
else if(strcmp(server_nuser,"Bob")==0)
{
char *directory = "/home/swaminath/Downloads/split/pairs/server2/Bob";
chdir (directory); 
...
char *directory1 = "/home/swaminath/Downloads/split/pairs/server2";
chdir (directory1); 
}
...
char *directory2 = "/home/swaminath/Downloads/split/pairs/server2";
chdir (directory2); 
}
...
char *directory3 = "/home/swaminath/Downloads/split/pairs/server2";
chdir (directory3);
}
