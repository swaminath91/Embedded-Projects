...
/*Creating a socket at the client end*/
 ...
 if ((clientSocket4 = socket(AF_INET, SOCK_STREAM, 0))== -1) {
  ...
  server_info1.sin_addr.s_addr = inet_addr(server_1);//assigning any port number above 5000
...
server_info2.sin_family = AF_INET;
  server_info2.sin_addr.s_addr = inet_addr(server_2);
   server_info2.sin_port = htons((int)port_ser2);//assigning the ip address of the hostany port number above 5000
...
server_info3.sin_family = AF_INET;
   server_info3.sin_port = htons((int)port_ser3);//assigning the ip address of the host
...
server_info4.sin_family = AF_INET;
  ...
  server_info4.sin_addr.s_addr = inet_addr(server_4);//assigning any port number above 5000
