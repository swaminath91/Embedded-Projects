...
/* ******* checking for whether a valid HTTP request and it's also a GET request ********* */   
...
/* ********* client connection address and details *********** */   
...
/* checking for whether a valid GET HTTP request ********** */
if(temp!=NULL)
...
if(!(n<=0))
/* ****** sending the response to web client ********** */
